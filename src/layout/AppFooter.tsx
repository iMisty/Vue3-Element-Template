      ...
      <div class="app__footer">
        <div class="container">
          <section class="app__footer--logo">
            <img class="app__footer--logo--img" src={this.logo} alt="logo" />
            <h4 class="app__footer--logo--text">{this.logoText}</h4>
          </section>
